...
const App: FC<{ folders?: any[]; activeFolder?: any; activeDoc?: any; activeDocs?: any[] }> = ({
  ...
  const handlenNewFolder = async (name: string) => {
    ...
    setAllFolders((oldState) => [...oldState, data]);
  };
  ...
  return (
    <Pane position="relative">
      ...
      <NewFolderDialog close={() => setIsShown(false)} isShown={newFolderIsShown} onNewFolder={handlenNewFolder} />
    </Pane>
  );
};
